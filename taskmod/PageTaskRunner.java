...
//    // Click Task button
	...
	public void CreateTaskStatues() throws InterruptedException {
		...
		// select Fever
		Selectone(pom.getPageTask().getSelectFever(), "demo");
...
//
		...
		// Select Tech1 Test
		Selectone(pom.getPageTask().getselectTech1Test(), "Martin Edward");
		...
		// Click Category
		Selectone(pom.getPageTask().getSelectcategory(), "demo");
...
// sele assign
		...
		Selectone(pom.getPageTask().getseleassign(), "Martin Edward");
...
////////////////ADD NEW TASK  ///////////////
		...
		Selectone(pom.getPageTask().getcatsele(), "demo");
...
// sendkeys(pom.getPageTask().getseletem(), "New 123");
		...
		try {
			...
			sendkeys(pom.getPageTask().getpatna(), "test");
